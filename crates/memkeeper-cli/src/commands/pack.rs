...
use super::{
    ...
    maybe_embed_remember_request, maybe_embed_search_request, parse_bool, parse_f64_arg,
    parse_json_command_args, parse_usize_arg, print_result, rerank_doc_chars,
    rerank_pool_documents, ArgParser, SemanticModels,
};
